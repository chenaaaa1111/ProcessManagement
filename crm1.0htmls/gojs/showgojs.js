...
function init() {
    ...
    var paraid=geturl('id');
    console.log('paraid',paraid);
    request({
      url:'http://gj.i2f2f.com/public/index.php/index/members/manager',
      type:'post',
      data:{pid:paraid},
    ...
    myPalette =
      $(go.Palette, "myPaletteDiv",  // must name or refer to the DIV HTML element
        ...
        myDiagram.addDiagramListener("ObjectSingleClicked", function(e) {
          ...
          // var text=e.subject.part.jb.text;
          ...
          // document.getElementById('t6').innerHTML=text;
          // document.getElementById('t7').innerHTML=text;
          // document.getElementById('t8').innerHTML=text;
          // document.getElementById('t9').innerHTML=text;
          // document.getElementById('t10').innerHTML=text;
          // document.getElementById('t11').innerHTML=text;
